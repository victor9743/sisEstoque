...
class EstoquesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create estoque" do
    assert_difference('Estoque.count') do
      post estoques_url, params: { estoque: { dataentrada: @estoque.dataentrada, datasaida: @estoque.datasaida, qtdentrada: @estoque.qtdentrada, qtdsaida: @estoque.qtdsaida, valorentrada: @estoque.valorentrada, valorsaida: @estoque.valorsaida } }
    end
  ...
  test "should update estoque" do
    patch estoque_url(@estoque), params: { estoque: { dataentrada: @estoque.dataentrada, datasaida: @estoque.datasaida, qtdentrada: @estoque.qtdentrada, qtdsaida: @estoque.qtdsaida, valorentrada: @estoque.valorentrada, valorsaida: @estoque.valorsaida } }
