...
class ProdutosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create produto" do
    assert_difference('Produto.count') do
      post produtos_url, params: { produto: { codbarras: @produto.codbarras, dtavalidade: @produto.dtavalidade, nomeproduto: @produto.nomeproduto } }
    end
  ...
  test "should update produto" do
    patch produto_url(@produto), params: { produto: { codbarras: @produto.codbarras, dtavalidade: @produto.dtavalidade, nomeproduto: @produto.nomeproduto } }
